...
public struct GouraudShader : IShader
{
    ...
    private Vector4 _light_dir;
    private Vector3 _varyingIntensity;
    private Matrix4x4 _varyingUv;
    public Matrix4x4 VaryingTri { get; private set; }
    private Texture2D _texture;
    public GouraudShader(FileReader filereader, Matrix4x4 viewMatrix, Vector4 lightDir, Texture2D texture2D)
    {
        _model = filereader;
    ...
    public Color Fragment(Vector3 bar)
    {
        ...
        var color = _texture.GetPixel((int)uv.x,(int)uv.y) * intensity;
